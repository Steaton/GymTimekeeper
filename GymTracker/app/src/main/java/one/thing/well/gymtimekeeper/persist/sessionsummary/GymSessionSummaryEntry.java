...
public class GymSessionSummaryEntry {

    private Date sessionStartDate;

    private Date sessionEndDate;

    public GymSessionSummaryEntry(Date sessionStartDate, Date sessionEndDate) {
        this.sessionStartDate = sessionStartDate;
        this.sessionEndDate = sessionEndDate;
    }

    public GymSessionSummaryEntry(String sessionSummaryString) throws ParseException {
