...
public class PlaceholderFragment extends android.support.v4.app.Fragment {
    ...
    private LocationEventFileReader fileReaderForStackViewFragment;
     ...
     */
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            fileReaderForStackViewFragment = new LocationEventFileReader(GymTimekeeperApplication.getAppContext());
    ...
    private void displayGymLocationEventsForTheFragment(){
        ...
        try {
            ...
            LocationEventFile file = fileReaderForStackViewFragment.readGymLocationEventFile();
